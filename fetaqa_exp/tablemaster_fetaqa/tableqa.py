...
sys.path.append('./fetaqa_exp/tablemaster_fetaqa')
sys.path.append('./')
...
def tablemaster_table_understanding(table_array, question, task='qa', question_i=0):
    ...
    final_answer, textual_reasoning_process, symbolic_reasoning_process = table_reasoning_for_qa(table_array, verbalized_table, question, task=task, question_i=question_i)
    reasoning_process = {
