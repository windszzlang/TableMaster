...
def tablemaster_table_understanding(table_array, question, task='qa'):
    ...
    # final_answer, textual_reasoning_process, symbolic_reasoning_process = table_reasoning_for_qa(subtable_array, verbalized_table, question, task=task)
    reasoning_process = {
