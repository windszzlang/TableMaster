...
parser.add_argument('--repeat_number', type=int, default=1)
...
output_path = f'outputs/baselines/{dataset}/{model}/mix_sc/{REPEAT_NUMBER}/{prompt_type}/'
...
def llm_reason(table, question):
    ...
    response = get_openai_llm_response(prompt, model=model_name, json_output=False, temperature=temperature)
