...
def table_content_understanding(table_array, question, selected_row_indices, selected_column_indices, ranked_column_indices, peek_size):
    ...
    while True:
        ...
        peek_table_md = format_table(table_array[:peek_size], with_address=False)
        verbalized_table = table_verbalization(peek_table_md)
