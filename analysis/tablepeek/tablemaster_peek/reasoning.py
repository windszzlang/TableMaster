...
def reasoning_strategy_assessment(table_array, question, peek_size):
...
```
'''
    table_md = format_table(table_array[:peek_size], with_address=False)
...
def table_reasoning_for_qa(table_array, verbalized_table, question, task='qa', peek_size=10000):
    program_aided = reasoning_strategy_assessment(table_array, question, peek_size)
